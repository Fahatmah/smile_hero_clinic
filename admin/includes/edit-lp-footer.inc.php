...
if($_SERVER['REQUEST_METHOD'] === "POST"){
    ...
    $query = "UPDATE footer SET title_one = ?, title_two = ?, contact = ?, email = ?, socmedname = ?, socmedlink = ?, address = ?, otherbranch_one = ?, otherbranch_one_link = ?, otherbranch_two = ?, otherbranch_two_link = ?, paragraph = ?";
